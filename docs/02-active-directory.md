...
During the deployment process, the server was promoted to a Domain Controller and a new Active Directory forest was created.
...
Each user belongs to the appropriate Organizational Unit and can authenticate using domain credentials.
...
This approach follows Microsoft's recommended access control practices.
...
After joining the domain, computer objects automatically appeared within Active Directory.
...
| Active Directory Administrative Center | Optional administration      |
...
| Domain created successfully   | Passed          |    ✅   |
| User authentication           | Passed          |    ✅   |
| Client joined to domain       | Passed          |    ✅   |
| Computer objects visible      | Passed          |    ✅   |
...
Using Organizational Units, domain users, security groups, and domain-joined Windows 11 clients, the infrastructure demonstrates core enterprise administration practices commonly used in production Windows Server environments.
